  ...
  const openFontPicker = useCallback(() => {
    optionSheetRef.current?.open({
      ...
      options: [
        ...
        {
          label: copy.comicSans,
          value: "comicsans",
          icon: "emoticon-happy",
          fontFamily: getAppFontFamily("comicsans"),
        },
        {
          label: copy.okxSans,
          value: "okxsans",
          icon: "format-font",
          fontFamily: getAppFontFamily("okxsans"),
        },
        {
          label: copy.ourFont,
          value: "ourfont",
          icon: "draw",
          fontFamily: getAppFontFamily("ourfont"),
        },
        {
          label: copy.studioFeixen,
          value: "studiofeixen",
          icon: "format-font",
          fontFamily: getAppFontFamily("studiofeixen"),
        },
        {
          label: copy.twkEverett,
          value: "twkeverett",
          icon: "format-font",
          fontFamily: getAppFontFamily("twkeverett"),
        },
        {
          label: copy.suisseIntl,
          value: "suisseintl",
          icon: "format-font",
          fontFamily: getAppFontFamily("suisseintl"),
        },
      ],
