...
export const styles = StyleSheet.create({
  ...
  selectButtonText: { flex: 1, minWidth: 0, fontWeight: "900" },
  ...
  selectOptionLabel: { flex: 1, minWidth: 0, fontSize: 13, fontWeight: "800" },
  ...
  statCard: { flexGrow: 1, flexBasis: "48%", minWidth: 0, borderWidth: 1, borderRadius: 12, padding: 13, position: "relative", flexDirection: "row", alignItems: "center", gap: 10 },
  ...
  txGroupCard: { borderWidth: 1, borderRadius: 10, overflow: "hidden" },
  groupedTxRow: { minHeight: 62, paddingHorizontal: 14, paddingVertical: 11, flexDirection: "row", alignItems: "center", gap: 12 },
  ...
  kpi: { flexGrow: 1, flexBasis: "23%", minWidth: 150, borderWidth: 1, borderRadius: 10, padding: 15 },
  ...
  searchSheet: { width: "100%", maxHeight: "88%", borderTopWidth: 1, borderTopLeftRadius: 22, borderTopRightRadius: 22, overflow: "hidden" },
  ...
  searchTitle: { fontSize: 19, fontWeight: "900" },
  searchSubtitle: { marginTop: 3, fontSize: 12, fontWeight: "700" },
  searchBody: { flexShrink: 1 },
  searchScrollContent: { paddingHorizontal: 14, paddingTop: 2, paddingBottom: 12, gap: 10 },
  searchSection: { borderWidth: 1, borderRadius: 16, padding: 12, gap: 10 },
  searchSectionHeader: { flexDirection: "row", alignItems: "center", gap: 8 },
  searchSectionTitle: { fontSize: 13, fontWeight: "900", textTransform: "uppercase" },
  ...
  searchActionText: { fontSize: 14, fontWeight: "900" },
